...
class RtuMaster(Master):
    ...
    def __init__(self, ser_port, ser_baud, ser_bytesize, ser_parity, ser_stopbits, interchar_multiplier=1.5, interframe_multiplier=3.5, t0=None):
        """Constructor. Pass the pyserial.Serial object"""
        self._serial = serial.Serial(port=ser_port, baudrate=ser_baud, bytesize=ser_bytesize, parity=ser_parity, stopbits=ser_stopbits)
