...
"}")
        ...
        self.groupBox.setGeometry(QtCore.QRect(4, 825, 770, 450))
        font = QtGui.QFont()
...
"")
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10, 60, 746, 81))
        self.gridLayoutWidget.setObjectName("gridLayoutWidget")
        self.gridLayout = QtWidgets.QGridLayout(self.gridLayoutWidget)
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.gridLayout.setObjectName("gridLayout")
        self.DiagBrake2VLabel = QtWidgets.QLabel(self.gridLayoutWidget)
        self.DiagBrake2VLabel.setObjectName("DiagBrake2VLabel")
        self.gridLayout.addWidget(self.DiagBrake2VLabel, 1, 2, 1, 1)
        self.DiagBrake1V = QtWidgets.QLabel(self.gridLayoutWidget)
        self.DiagBrake1V.setText("")
        self.DiagBrake1V.setObjectName("DiagBrake1V")
        self.gridLayout.addWidget(self.DiagBrake1V, 1, 1, 1, 1)
        self.DiagBrake2V = QtWidgets.QLabel(self.gridLayoutWidget)
        self.DiagBrake2V.setText("")
        self.DiagBrake2V.setObjectName("DiagBrake2V")
        self.gridLayout.addWidget(self.DiagBrake2V, 1, 3, 1, 1)
        self.DiagThrottleVLabel = QtWidgets.QLabel(self.gridLayoutWidget)
        self.DiagThrottleVLabel.setObjectName("DiagThrottleVLabel")
        self.gridLayout.addWidget(self.DiagThrottleVLabel, 0, 0, 1, 1)
        self.DiagBMSVLabel = QtWidgets.QLabel(self.gridLayoutWidget)
        self.DiagBMSVLabel.setObjectName("DiagBMSVLabel")
        self.gridLayout.addWidget(self.DiagBMSVLabel, 0, 2, 1, 1)
        self.DiagThrottleV = QtWidgets.QLabel(self.gridLayoutWidget)
        self.DiagThrottleV.setText("")
        self.DiagThrottleV.setObjectName("DiagThrottleV")
        self.gridLayout.addWidget(self.DiagThrottleV, 0, 1, 1, 1)
        self.DiagBMSV = QtWidgets.QLabel(self.gridLayoutWidget)
        self.DiagBMSV.setText("")
        self.DiagBMSV.setObjectName("DiagBMSV")
        self.gridLayout.addWidget(self.DiagBMSV, 0, 3, 1, 1)
        self.DiagBrake1VLabel = QtWidgets.QLabel(self.gridLayoutWidget)
        self.DiagBrake1VLabel.setObjectName("DiagBrake1VLabel")
        self.gridLayout.addWidget(self.DiagBrake1VLabel, 1, 0, 1, 1)
        self.gridLayoutWidget_2 = QtWidgets.QWidget(self.groupBox)
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(10, 140, 746, 303))
        self.gridLayoutWidget_2.setObjectName("gridLayoutWidget_2")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.gridLayoutWidget_2)
        self.gridLayout_2.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.DiagDigitalInputsLabel = QtWidgets.QLabel(self.gridLayoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.DiagDigitalInputsLabel.sizePolicy().hasHeightForWidth())
        self.DiagDigitalInputsLabel.setSizePolicy(sizePolicy)
        self.DiagDigitalInputsLabel.setObjectName("DiagDigitalInputsLabel")
        self.gridLayout_2.addWidget(self.DiagDigitalInputsLabel, 1, 0, 1, 1)
        self.DiagWarningsLabel = QtWidgets.QLabel(self.gridLayoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.DiagWarningsLabel.sizePolicy().hasHeightForWidth())
        self.DiagWarningsLabel.setSizePolicy(sizePolicy)
        self.DiagWarningsLabel.setObjectName("DiagWarningsLabel")
        self.gridLayout_2.addWidget(self.DiagWarningsLabel, 2, 0, 1, 1)
        self.DiagEbikeFlagsLabel = QtWidgets.QLabel(self.gridLayoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.DiagEbikeFlagsLabel.sizePolicy().hasHeightForWidth())
        self.DiagEbikeFlagsLabel.setSizePolicy(sizePolicy)
        self.DiagEbikeFlagsLabel.setObjectName("DiagEbikeFlagsLabel")
        self.gridLayout_2.addWidget(self.DiagEbikeFlagsLabel, 0, 0, 1, 1)
        self.DiagWarnings = QtWidgets.QLabel(self.gridLayoutWidget_2)
        self.DiagWarnings.setStyleSheet("QLabel{font: 12pt \'Luxi Mono\'}")
        self.DiagWarnings.setText("")
        self.DiagWarnings.setWordWrap(True)
        self.DiagWarnings.setObjectName("DiagWarnings")
        self.gridLayout_2.addWidget(self.DiagWarnings, 2, 1, 1, 1)
        self.DiagSensorlessLabel = QtWidgets.QLabel(self.gridLayoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.DiagSensorlessLabel.sizePolicy().hasHeightForWidth())
        self.DiagSensorlessLabel.setSizePolicy(sizePolicy)
        self.DiagSensorlessLabel.setObjectName("DiagSensorlessLabel")
        self.gridLayout_2.addWidget(self.DiagSensorlessLabel, 3, 0, 1, 1)
        self.DiagSensorless = QtWidgets.QLabel(self.gridLayoutWidget_2)
        self.DiagSensorless.setStyleSheet("QLabel{font: 12pt \'Luxi Mono\'}")
        self.DiagSensorless.setText("")
        self.DiagSensorless.setWordWrap(True)
        self.DiagSensorless.setObjectName("DiagSensorless")
        self.gridLayout_2.addWidget(self.DiagSensorless, 3, 1, 1, 1)
        self.DiagDigitalInputs = QtWidgets.QLabel(self.gridLayoutWidget_2)
        self.DiagDigitalInputs.setStyleSheet("QLabel{font: 12pt \'Luxi Mono\'}")
        self.DiagDigitalInputs.setText("")
        self.DiagDigitalInputs.setWordWrap(True)
        self.DiagDigitalInputs.setObjectName("DiagDigitalInputs")
        self.gridLayout_2.addWidget(self.DiagDigitalInputs, 1, 1, 1, 1)
        self.DiagEbikeFlags = QtWidgets.QLabel(self.gridLayoutWidget_2)
        font = QtGui.QFont()
        font.setFamily("Luxi Mono")
        ...
        font.setItalic(False)
        font.setWeight(50)
        self.DiagEbikeFlags.setFont(font)
        self.DiagEbikeFlags.setStyleSheet("QLabel{font: 12pt \'Luxi Mono\'}")
        self.DiagEbikeFlags.setText("")
        self.DiagEbikeFlags.setWordWrap(True)
        self.DiagEbikeFlags.setObjectName("DiagEbikeFlags")
        self.gridLayout_2.addWidget(self.DiagEbikeFlags, 0, 1, 1, 1)
...
"}")
        ...
        self.HackAccessBtn.setGeometry(QtCore.QRect(5, 1280, 65, 65))
        font = QtGui.QFont()
        font.setFamily("Magneto")
        font.setBold(False)
        font.setItalic(False)
        ...
        self.HackAccessLabel.setGeometry(QtCore.QRect(75, 1280, 670, 65))
...
"    ")
        ...
        self.HackAccessLabel_code1.setGeometry(QtCore.QRect(10, 1365, 194, 65))
...
"}")
        ...
        self.HackAccessLabel_code2.setGeometry(QtCore.QRect(265, 1365, 194, 65))
...
"}")
        ...
        self.HackAccessLabel_code3.setGeometry(QtCore.QRect(540, 1365, 194, 65))
...
"}")
    ...
    def retranslateUi(self, OptDialog):
        ...
        self.DiagBrake2VLabel.setText(_translate("OptDialog", "Brake2 Volt:"))
        self.DiagThrottleVLabel.setText(_translate("OptDialog", "Throttle Volt:"))
        self.DiagBMSVLabel.setText(_translate("OptDialog", "BMS ADC Volt:"))
        self.DiagBrake1VLabel.setText(_translate("OptDialog", "Brake1 Volt:"))
        self.DiagDigitalInputsLabel.setText(_translate("OptDialog", "DigiInputs:"))
        self.DiagWarningsLabel.setText(_translate("OptDialog", "Warnings:"))
        self.DiagEbikeFlagsLabel.setText(_translate("OptDialog", "EbikeFlags:"))
        self.DiagSensorlessLabel.setText(_translate("OptDialog", "Sensorless:"))
