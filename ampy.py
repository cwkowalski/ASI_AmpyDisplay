...
"}")
        ...
        self.PID_Kd_Label_2 = QtWidgets.QLabel(self.TripBox)
        self.PID_Kd_Label_2.setGeometry(QtCore.QRect(880, 530, 411, 41))
        font = QtGui.QFont()
        font.setFamily("Magneto")
        font.setPointSize(30)
        font.setBold(False)
        font.setItalic(False)
        font.setWeight(50)
        self.PID_Kd_Label_2.setFont(font)
        self.PID_Kd_Label_2.setStyleSheet("QLabel{\n"
"    font: 30pt \"Magneto\";\n"
"}")
        self.PID_Kd_Label_2.setAlignment(QtCore.Qt.AlignCenter)
        self.PID_Kd_Label_2.setObjectName("PID_Kd_Label_2")
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.PID_Kd_Label_2.setText(_translate("MainWindow", "Kd"))
